...
class DataBase {
  ...
  static void onCreate(Database db, int version) async =>
      await db.execute('CREATE TABLE server_items (id INTEGER PRIMARY KEY AUTOINCREMENT, title STRING, complete BOOLEAN)');
  ...
  static Future<int> update(String table, ServerModel model) async =>
      await _db.update(table, model.toMap(), where: 'id = ?', whereArgs: [model.id, model.title]);
